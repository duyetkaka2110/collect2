...
<!-- Modal DONE -->
<div class="modal fade" id="DoneModal" role="dialog" data-backdrop="static" tabindex="-1">
    <div class="modal-dialog">
        <!-- Modal content-->
        <div class="modal-content">
            <div class="modal-header modal-header-error bg-primary">
                <h5 class="modal-title text-white">情報メッセージ</h5>
            </div>
            <div class="modal-body">
                {{ @Session::get('DoneMsg') }}
            </div>
            <div class="modal-footer text-center">
                <button type="button" class="btn btn-primary close-modal w-6em" data-dismiss="modal">閉じる</button>
            </div>
        </div>
    </div>
</div>
